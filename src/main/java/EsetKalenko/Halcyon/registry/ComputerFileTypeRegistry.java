...
public class ComputerFileTypeRegistry {
    public static final DeferredRegister<ComputerFileType> COMPUTER_FILE_TYPES = DeferredRegister.create(DataNEssenceRegistries.COMPUTER_FILE_TYPES_REGISTRY_KEY, Halcyon.MOD_ID);
