...
import EsetKalenko.Halcyon.screen.widget.FluidWidget;
...
public class MineralPurificationChamberScreen extends AbstractContainerScreen<MineralPurificationChamberMenu> {
    public static final ResourceLocation TEXTURE = Halcyon.locate("textures/gui/mineral_purification_chamber.png");
