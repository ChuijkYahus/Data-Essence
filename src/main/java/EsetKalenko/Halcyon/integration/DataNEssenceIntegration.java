package EsetKalenko.Halcyon.integration;
...
public class DataNEssenceIntegration {
    ...
    public static void init() {
        ...
        if (hasMekanism) {
            Halcyon.LOGGER.info("[HALCYON] Mekanism detected; enabling integration features. Careful with your reactors!");
        ...
        if (hasOpalescence)
            Halcyon.LOGGER.info("[HALCYON] Opalescence detected; enabling integration features. I hear this rock is a favorite of dragons!");
        if (hasPastel)
            Halcyon.LOGGER.info("[HALCYON] Pastel detected; enabling integration features. Are you an Artist, or a Factory Conductor, or both?");
    }
