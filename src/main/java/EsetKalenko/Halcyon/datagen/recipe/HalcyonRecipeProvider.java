...
public class HalcyonRecipeProvider extends RecipeProvider {

    public HalcyonRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        new InfusionRecipeBuilder(new ItemStack(ItemRegistry.ESSENCE_SHARD.get()), Ingredient.of(Items.AMETHYST_SHARD), Halcyon.locate("basics/essence_crystals"), -1, Map.of(DataNEssenceRegistries.ESSENCE_TYPE_REGISTRY.getKey(EssenceTypeRegistry.ESSENCE.get()), 100f), true).unlockedBy("has_shard", has(Items.AMETHYST_SHARD)).save(output);
        // new InfusionRecipeBuilder(new ItemStack(ItemRegistry.LUNAR_ESSENCE_SHARD.get()), Ingredient.of(Items.AMETHYST_SHARD), DataNEssence.locate("basics/lunar_strikes"), -1, Map.of(DataNEssenceRegistries.ESSENCE_TYPE_REGISTRY.getKey(EssenceTypeRegistry.LUNAR_ESSENCE.get()), 100f), true).unlockedBy("has_shard", has(Items.AMETHYST_SHARD)).save(output);
