...
public class DataNEssenceConfig {
    ...
    public DataNEssenceConfig(ModConfigSpec.Builder builder) {
        ...
        essencePointTransferValue = buildInteger(builder, "essenceNodeTransfer", 50, 1, 1000000, "The base, un-upgraded rate that all Tidal Energy Nodes can transfer per tick.");
